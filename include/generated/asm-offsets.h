...
#define CPUINFO_x86_vendor_id 76 /* offsetof(struct cpuinfo_x86, x86_vendor_id)	# */
...
#define TSS_sysenter_sp0 -8552 /* offsetof(struct tss_struct, x86_tss.sp0) - offsetofend(struct tss_struct, SYSENTER_stack)	# */

#define __NR_syscall_max 359 /* sizeof(syscalls) - 1	# */
#define NR_syscalls 360 /* sizeof(syscalls)	# */
...
#define TI_sysenter_return 24 /* offsetof(struct thread_info, sysenter_return)	# */
